...
LastEditTime: 2022-08-02 16:08:18
...
def get_click_data():
    ...
    for day in range(1, 2, 1):
        ...
        npy_classify_file = os.path.join('/data/search_opt_model/topk_opt/rank_data_based_request_id_eval/eval_classify_'+get_before_day(day)+'.npy')
        np.save(npy_classify_file, eval_classify_samples)
