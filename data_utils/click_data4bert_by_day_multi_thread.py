...
LastEditTime: 2022-08-02 16:06:58
    ...
    def get_corpus(self, obj_ids_list):
        ...
        def get_data_by_thread(obj_ids, content_type, corpus):
            ...
            for thread_id in get_info_name_list:
                thread = dataProcessFromDb(thread_id, objIdQueue, data_queue, objNum, content_type, objType, globalTaskNum)  # 启动线程
                thread.start()  # 启动线程
...
def get_click_data():
    ...
    for day in range(1, 31, 1):
        ...
        pkl_file = os.path.join('/data/search_opt_model/topk_opt/rank_data_multi_thread/data_'+get_before_day(day)+'.pkl')
