...
def get_click_data():
    ...
    for day in range(1, 2, 1):
        ...
        pkl_file = os.path.join('/data', folder_name, 'topk_opt/rank_data_classify/data_'+get_before_day(day)+'.pkl')
        npy_classify_file = os.path.join('/data', folder_name, 'topk_opt/rank_data_classify_eval/eval_classify_'+get_before_day(day)+'.npy')
