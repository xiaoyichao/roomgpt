...
featureEncodeJsonFile = "/data/search_opt_model/topk_opt/fine_row_feature_encode.json"
fineRowHashDataJsonFile = "/data/search_opt_model/topk_opt/fine_row_hash_data.json"
...
def get_click_data():
    ...
    for day in range(1, 62, 1):
        ...
        pkl_file = os.path.join('/data/search_opt_model/topk_opt/rank_fine_row_userprofile/data_'+get_before_day(day)+'.pkl')
        write_samples_pkl(click_format_datas, pkl_file)

        npy_classify_file = os.path.join('/data/search_opt_model/topk_opt/rank_fine_row_userprofile_eval/eval_classify_' + get_before_day(
                                             day) + '.npy')
