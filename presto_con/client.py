...
https://github.com/presto_con/presto/wiki/HTTP-Protocol
...
from presto_con import exceptions
import presto_con.presto_logging
from presto_con.transaction import NO_TRANSACTION
...
class PrestoRequest(object):
    ...
    def http_headers(self):
        ...
        # print('self._client_session.headers:')
        # print(self._client_session.headers)
