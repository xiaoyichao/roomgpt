...
featureEncodeJsonFile = "/data/search_opt_model/topk_opt/fine_row_cv_feature_encode.json"
fineRowHashDataJsonFile = "/data/search_opt_model/topk_opt/fine_row_cv_hash_data.json"
...
select 
 ...
 from k join l on k.flag=l.flag order by search_request_id, query, uid, position asc limit 10000''' % (day, day)
...
def get_click_data():
    ...
    for day in range(1, 2, 1):
        ...
        pkl_file = os.path.join('/data/search_opt_model/topk_opt/rank_fine_row_cv_userprofile/data_'+get_before_day(day)+'.pkl')
        write_samples_pkl(click_format_datas, pkl_file)

        npy_classify_file = os.path.join('/data/search_opt_model/topk_opt/rank_fine_row_cv_userprofile_eval/eval_classify_' + get_before_day(
                                             day) + '.npy')
