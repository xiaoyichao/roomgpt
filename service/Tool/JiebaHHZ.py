...
class JiebaHHZ(object):
    ...
    #  自定义词汇 文件地址
    UserTagFile = "/home/adm_rsync_dir/search_op/jieba_user_define_words_v1.dic"
    # 自定义词汇 修改时间
    UserTagModifyTime = 0
    ...
    @classmethod
    def SplitWords(cls, sentence, isGetUnique = True, isFilterStopwords = False):
        """
        将句子变成切词后的list
        Args:
        ...
        for returnDataItem in returnDataTmp:
            ...
            if len(returnDataItemTmp) > 0:
                if isGetUnique:
                    if returnDataItemTmp not in returnData:
...
if __name__ == '__main__':
    ...
    print(JiebaHHZ.SplitWords(line))
