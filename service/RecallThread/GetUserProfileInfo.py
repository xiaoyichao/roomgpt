...
import json
import configparser
from cache.UserProfile import UserProfile
...
class GetUserProfileInfo(threading.Thread):
    '''
    线程类，注意需要继承线程类Thread
    '''
    # 标记线程类
    TYPE = "GetUserProfileInfo"
    ...
    def recall(self):
        ...
        try:
            ...
            userProfileInfo = UserProfile.getUserProfileInfoByUid(self.init_resource_cls, uid)
