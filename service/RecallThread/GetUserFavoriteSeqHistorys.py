...
class GetUserFavoriteSeqHistorys(threading.Thread):
    '''
    线程类，注意需要继承线程类Thread
    '''
    # 标记线程类
    TYPE = "GetUserFavoriteSeqHistorys"
    ...
    def recall(self):
        ...
        try:
            ...
            userFavoriteSeqHistorys = UserValidClickAndFavorite.getUserFavorites(self.init_resource_cls, uid)
